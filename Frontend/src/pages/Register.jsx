        ...
        <div className="grid lg:grid-cols-2 gap-0 bg-neutral-bg-100 dark:bg-dark-bg-100 rounded-2xl shadow-2xl overflow-hidden border border-neutral-bg-300 dark:border-dark-bg-300">
          ...
          <div className="p-8 lg:p-12 flex flex-col justify-center">
            ...
            <div className="lg:hidden text-center mb-8">
              ...
              <p className="text-text-secondary dark:text-dark-text-secondary">Create your account to get started</p>
            </div>

            {/* Desktop Header */}
            <div className="hidden lg:block mb-8">
              <h2 className="text-3xl font-bold text-text-primary dark:text-dark-text-primary mb-2">Create Account</h2>
              <p className="text-text-secondary dark:text-dark-text-secondary">Join now and start the conversation</p>
            </div>
            ...
            <form onSubmit={handleRegister} className="space-y-6">
              ...
              <div className="space-y-2">
                <label htmlFor="confirm-password" className="block text-sm font-medium text-text-primary dark:text-dark-text-primary">
                  Confirm Password
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
